...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ResourcesLibraryAccessors laccForResourcesLibraryAccessors = new ResourcesLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>qrose</b> with <b>io.github.alexzhirkevich:qrose</b> coordinates and
     * with version reference <b>qrose</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getQrose() {
        return create("qrose");
    }

    /**
     * Dependency provider for <b>resourcesTest</b> with <b>dev.icerock.moko:resources-test</b> coordinates and
     * with version reference <b>resourcesGenerator</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getResourcesTest() {
        return create("resourcesTest");
    }
    ...
    /**
     * Group of libraries at <b>resources</b>
     */
    public ResourcesLibraryAccessors getResources() {
        return laccForResourcesLibraryAccessors;
    }
    ...
    public static class ResourcesLibraryAccessors extends SubDependencyFactory {
        private final ResourcesComposeLibraryAccessors laccForResourcesComposeLibraryAccessors = new ResourcesComposeLibraryAccessors(owner);

        public ResourcesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>generator</b> with <b>dev.icerock.moko:resources-generator</b> coordinates and
         * with version reference <b>resourcesGenerator</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGenerator() {
            return create("resources.generator");
        }

        /**
         * Dependency provider for <b>moko</b> with <b>dev.icerock.moko:resources</b> coordinates and
         * with version reference <b>resourcesGenerator</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMoko() {
            return create("resources.moko");
        }

        /**
         * Group of libraries at <b>resources.compose</b>
         */
        public ResourcesComposeLibraryAccessors getCompose() {
            return laccForResourcesComposeLibraryAccessors;
        }

    }

    public static class ResourcesComposeLibraryAccessors extends SubDependencyFactory {

        public ResourcesComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>moko</b> with <b>dev.icerock.moko:resources-compose</b> coordinates and
         * with version reference <b>resourcesGenerator</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMoko() {
            return create("resources.compose.moko");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koinCore</b> with value <b>3.5.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>qrcodeKotlin</b> with value <b>4.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>qrose</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getQrose() { return getVersion("qrose"); }

        /**
         * Version alias <b>resourcesGenerator</b> with value <b>0.24.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getResourcesGenerator() { return getVersion("resourcesGenerator"); }
        ...
        /**
         * Version alias <b>versionMoko</b> with value <b>0.24.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersionMoko() { return getVersion("versionMoko"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.navigation</b> with value <b>2.7.0-alpha06</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
